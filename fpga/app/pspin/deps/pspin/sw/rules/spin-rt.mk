...
runtime-debug:
	...
	$(CC) $(CFLAGS) -fno-lto -c $(PULP_SDK)/runtime/libs/errno.c  -o build/errno.o
	$(CC) $(CFLAGS) ${SPIN_CFLAGS} $(PULP_INC) $(INCLUDE_FILES) $(PULP_SRCS) $(SRC_FILES) build/crt0.o -o $(TARGET_BIN) $(LDFLAGS) build/errno.o
